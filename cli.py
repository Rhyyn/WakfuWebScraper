...
ARMURES_CATEGORIES = {'amulette': 120, 'anneau': 103, 'bottes': 119, 'cape': 132,
                    'casque': 134, 'ceinture': 133, 'epaulettes': 138, 'plastron': 136}

ARMES_CATEGORIES = {'arme1main': [254, 108, 110, 115, 113], 
                    'arme2main': [223, 114, 101, 111, 253, 117], 
                    'secondemain': [112, 189]}

AUTRES_CATEGORIES = {'sublimation' : 812, 'emblemes' : 646, 'familier' : 582,
                    'montures' : 611, 'torches' : 480, 'outils' : 537}
...
def crawl_items_data():
    item_type = click.prompt('What type of items do you want to crawl?', type=click.Choice(ITEM_TYPES))
...
def crawl_armures():
    armure_category = click.prompt('What type of armures do you want to crawl?', type=click.Choice(list(map(str, ARMURES_CATEGORIES.keys()))))
...
def crawl_autres():
    autre_category = click.prompt('What type of autres do you want to crawl?', type=click.Choice(list(map(str, AUTRES_CATEGORIES.keys()))))
